...
### [FoodHub Data Analysis](https://github.com/DanielLevenstein/FoodHub_UT_ML_Project1)

- Analysed corrilations of 1898 row dataset and filled in missing columns with mean rating from existing data.
- Calculated top rated resturants by cuisine type, and restaurant.
- Calculated cost and population reaced mertrics for discount code designed to reward customer loyalty.
...
![Material Loss vs Num Colors](charts/material_loss_vs_num_colors.png)
